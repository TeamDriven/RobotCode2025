...
public final class Constants {
  ...
  public static setLevel highAlgae = new setLevel(ElevatorConstants.highDealgifyPos::get, ActuationConstants.dealgifyPos::get, IntakeConstants.intakeVelocity.getAsDouble());

  public static setLevel turtle = new setLevel(ElevatorConstants.turtlePos::get, ActuationConstants.turtlePos::get, IntakeConstants.intakeVelocity.getAsDouble());
