...
public class Coral1Algae2Left implements AutoBase {
    ...
    public AutoRoutine getAuto() {
        ...
        var pickup1 = routine.trajectory("coral 1 algae 2 left", 0);
        var place1 = routine.trajectory("coral 1 algae 2 left", 1);
        var pickup2 = routine.trajectory("coral 1 algae 2 left", 2);
        var place2 = routine.trajectory("coral 1 algae 2 left", 3);
        ...
        routine.active().onTrue(
                Commands.sequence(
                        ...
                        elevator.runOnce(() -> elevator.setPos(ElevatorConstants.lowDealgifyPos.get())),
                        intake.runOnce(() -> intake.runVelocity(intakeVelocity.get())),
                        Commands.waitUntil(() -> elevator.isAtHeight(ElevatorConstants.lowDealgifyPos.get(), 0.25)),
                        pickup1.cmd()
                ));
        ...
        place1.done().onTrue(Commands.sequence(
            drive.runOnce(() -> drive.acceptSimpleInput(0, 0, 0, false)),
