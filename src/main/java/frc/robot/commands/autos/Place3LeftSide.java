...
public class Place3LeftSide implements AutoBase {
    ...
    public AutoRoutine getAuto() {
        ...
        Transform2d place1Offset = new Transform2d(new Translation2d(Units.inchesToMeters(8), Units.inchesToMeters(-2)), new Rotation2d());
        Transform2d place2Offset = new Transform2d(new Translation2d(Units.inchesToMeters(6), Units.inchesToMeters(-3)), new Rotation2d());
        Transform2d place3Offset = new Transform2d(new Translation2d(Units.inchesToMeters(6.5), Units.inchesToMeters(-3.5)), new Rotation2d());
