...
public class LEDConstants {
    ...
    public static final int[] L4Color = {0, 255, 0};
    public static final int[] L3Color = {150, 20, 0};
    public static final int[] L2Color = {60, 120, 180};
    public static final int[] L1Color = {220, 206, 86};
    public static final int[] pickupColor = {172, 96, 184};
    public static final int[] highDealgifyColor = {230, 80, 40};
    public static final int[] lowDealgifyColor = {130, 50, 20};
    public static final int[] noneColor = {0, 0, 130};
