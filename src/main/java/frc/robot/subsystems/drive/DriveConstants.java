...
public final class DriveConstants {
  ...
  public static final ModuleConfig[] moduleConfigs = switch (Constants.getRobot()) {
    case COMPBOT -> new ModuleConfig[] {
        new ModuleConfig(1, 2, 3, new Rotation2d(-1.224117), true), 
        new ModuleConfig(4, 5, 6, new Rotation2d(-1.938952), true), 
        new ModuleConfig(7, 8, 9, new Rotation2d(-0.147262), true), 
        new ModuleConfig(10, 11, 12, new Rotation2d(-1.586136), true) 
    };
